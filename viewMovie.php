...
?>
		...
		<?php echo render_table( $directors, 'person-view.php', 'id', 'Name', 'Directed By', false ); ?>
		<br>
		<?php echo render_table( $cast, 'person-view.php', 'id', 'Name', 'Film Cast' ); ?>
		<br>
		<div class="comment-wrapper">
			<strong>User reviews</strong>
			<br>
			<?php echo hyperlink( 'review.php', $id, 'Add review'); ?>
