		...
		?>
			...
			<html>
				...
				<body>
					...
					<?php echo hyperlink( 'viewMovie.php', (int)$review['id'], 'Go back' ); ?>
				</body>
			</html>
		<?php
		die;
...
?>
		<form action="<?php echo 'review.php'; ?>" method="POST">
			<p>You are reviewing <strong><?php echo hyperlink( 'viewMovie.php', $movie['id'], $movie['title'], '_blank' ); ?></strong></p>
